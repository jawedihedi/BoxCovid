...
export class FormationService {
  ...
  addFormation(nameFormation: string, type: string,D: string,Sujet: string,Plan:string,Categorie:string) {
  ...
  updateBusiness(nameFormation: string, type: string, D: string,Sujet: string, id) {
